...
public final class SoundCullingTracker {
    ...
    public static int getCategoryLimit(SoundCategory category, SoundCullingConfig config) {
    ...
    public static float getVolumeMultiplier(Identifier soundId, SoundCategory category, double x, double y, double z) {
        SoundCullingConfig config = SoundCulling.getConfig();

        // UI and music sounds have no world position.
